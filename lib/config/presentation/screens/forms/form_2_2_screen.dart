...
class Form2Screen2 extends StatelessWidget {
  static const String name = 'form2_2'; 
  const Form2Screen2({super.key});
  @override
            ...
            Form(
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButtons(label: "Siguiente", screen: HomeScreen.name), 
                ],
              ),
            ),
          ]
